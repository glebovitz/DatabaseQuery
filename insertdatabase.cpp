...
InsertDatabase::InsertDatabase(QString connectionName, QObject *parent) :
    Database(connectionName, parent)
{
}

InsertDatabase::InsertDatabase(QStringList connectionString, QObject *parent) :
    Database(connectionString, parent)
{
}

void InsertDatabase::runQuery() {
#ifdef notdef
